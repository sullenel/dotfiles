" Vim color file
" Converted from Textmate theme GlitterBomb using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi Cursor ctermfg=232 ctermbg=189 cterm=NONE guifg=#0b0a0a guibg=#e2e9ff gui=NONE
...
hi VertSplit ctermfg=238 ctermbg=NONE cterm=NONE guifg=#444343 guibg=NONE gui=NONE
hi MatchParen ctermfg=178 ctermbg=NONE cterm=underline guifg=#dbb800 guibg=NONE gui=underline
...
hi IncSearch ctermfg=232 ctermbg=59 cterm=NONE guifg=#0b0a0a guibg=#4d6537 gui=NONE
...
hi DiffAdd ctermfg=252 ctermbg=64 cterm=bold guifg=#cfcfcf guibg=#417d07 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#850202 guibg=NONE gui=NONE
hi DiffChange ctermfg=252 ctermbg=17 cterm=NONE guifg=#cfcfcf guibg=#162a49 gui=NONE
hi DiffText ctermfg=252 ctermbg=24 cterm=bold guifg=#cfcfcf guibg=#204a87 gui=bold
