" Vim color file
" Converted from Textmate theme Blackboard Black using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi IncSearch ctermfg=234 ctermbg=77 cterm=NONE guifg=#1f1f1f guibg=#61ce3c gui=NONE
...
hi DiffAdd ctermfg=231 ctermbg=64 cterm=bold guifg=#f8f8f8 guibg=#45810b gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#890606 guibg=NONE gui=NONE
hi DiffChange ctermfg=231 ctermbg=23 cterm=NONE guifg=#f8f8f8 guibg=#203553 gui=NONE
...
hi NonText ctermfg=240 ctermbg=NONE cterm=NONE guifg=#575757 guibg=NONE gui=NONE
