" Vim color file
" Converted from Textmate theme idleFingers using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
hi CursorLine ctermfg=NONE ctermbg=237 cterm=NONE guifg=NONE guibg=#474747 gui=NONE
...
hi LineNr ctermfg=246 ctermbg=237 cterm=NONE guifg=#999999 guibg=#3a3a3a gui=NONE
hi VertSplit ctermfg=242 ctermbg=NONE cterm=NONE guifg=#6d6d6d guibg=NONE gui=NONE
...
hi NonText ctermfg=242 ctermbg=NONE cterm=NONE guifg=#686868 guibg=NONE gui=NONE
